...
isUseHTTPs = config.isUseHTTPs || false;
...
function serverHandler(request, response) {
    ...
    // custom API call
    if (customAPIs.isRoutesExist(request, response)) {
        customAPIs.doRoutesExecute(request, response);
        return;
    }
    ...
    try {
        ...
        var matched = false;
        ['/dist/', '/socket.io/'].forEach(function (item) {
